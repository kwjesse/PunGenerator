...
"""
Use ConceptNet script to get Hypernyms (Generalizations/Minimizations)
Example: A pixel is part of a computer

https://github.com/DrewTChrist/CANIS/blob/dev/modules/concept_query.py
"""
class HypernymConceptInquirer:
